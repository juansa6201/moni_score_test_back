...
if os.environ.get('IS_MYPY'):

    def get_env_or_raise(key: str) -> str:  # noqa: F811
        ...
...
if os.environ.get('DATABASE_URL') in (None, ''):
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'shared.exceptions.error_handler',
